...
function WatchDetail() {
  ...
  const handleBuy = () => {
    logBehavior(ACTION_TYPES.CLICK, `Bấm mua ngay: ${watch.name}`);
  ...
  return (
    <div className={`watch-detail-page ${fadeout ? "fade-out" : ""}`}>
      ...
      <div className="container">
        <RelatedProducts type="watch" currentName={watch.name} />
      </div>
    </div>
  );
}
